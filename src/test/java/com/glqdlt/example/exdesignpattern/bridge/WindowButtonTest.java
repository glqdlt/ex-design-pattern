...
import com.glqdlt.example.exdesignpattern.bridge.window.WindowButton;
import com.glqdlt.example.exdesignpattern.bridge.window.WindowCancelButton;
import com.glqdlt.example.exdesignpattern.bridge.window.WindowSubmitButton;
...
public class WindowButtonTest {
    ...
    public void windowSubmitButton() throws Exception {
        ...
        System.out.println(windowSubmitButton.getPlatformName());
    ...
    public void windowSubmitButtonWithCallback() throws Exception {
        ...
        System.out.println(callbackButton.getPlatformName());
